...
class StrongByZumba extends StatefulWidget {
  @override
  State<StatefulWidget> createState() {
    // TODO: implement createState

    return StrongByZumbaState();
  }

}

class StrongByZumbaState extends State<StrongByZumba>{
  ...
  if(packagedata!=null) {
    ...
    {
      if('StrongByZumba'==packagedata.documents[i].documentID)
      {
        break;
      }
            ...
            child: Column(
              children: <Widget>[
                      ...
                      child: Container(
                        ...
                        child: Column(
                          children: <Widget>[
                            Container(child: Row(
                              children: <Widget>[
                                Text("Strong by Zumba",style: TextStyle(fontSize: 20,fontWeight: FontWeight.bold),),
                              ],
                            )),
                            Container(
                            ...
                            Container(
                              margin: EdgeInsets.only(top: 7),
                              child: Text(
                                "Stop counting the reps, start training to the beat  ",style: TextStyle(fontWeight: FontWeight.bold),maxLines: 3,
                              ),
                            )
                ...
                Container(
                  ...
                  child: Row(
                    children: <Widget>[
                      Text("Tone your muscles",style: TextStyle(fontSize: 15,fontWeight: FontWeight.bold),),
                      SizedBox(width: 115,),
                      Icon(
                        Icons.check,
                        color: Colors.black,
                ...
                Container(
                  ...
                  child: Row(
                    children: <Widget>[
                      Text("Maximize your burn ",style: TextStyle(fontSize: 15,fontWeight: FontWeight.bold),),
                      SizedBox(width: 105,),
                      Icon(
                        Icons.check,
                        color: Colors.black,
                ...
                Container(
                  ...
                  child: Row(
                    children: <Widget>[
                      Text("Challenge your core",style: TextStyle(fontSize: 15,fontWeight: FontWeight.bold),),
                      SizedBox(width:105,),
                      Icon(
                        Icons.check,
                        color: Colors.black,
                ...
                Container(
                  ...
                  child: Row(
                    children: <Widget>[
                      Text("Every minute and every beat count",style: TextStyle(fontSize: 15,fontWeight: FontWeight.bold),),
                      SizedBox(width: 20,),
                      Icon(
                        Icons.check,
                        color: Colors.black,
