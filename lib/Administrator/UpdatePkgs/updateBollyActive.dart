...
class UpdateBollyActive extends StatefulWidget {
    @override
    _UpdateBollyActiveState createState() => _UpdateBollyActiveState();
}

class _UpdateBollyActiveState extends State<UpdateBollyActive> {
    FirebaseUser user;
    ...
    Widget build(BuildContext context) {
        if (packagedata != null) {
            for (i = 0; i < packagedata.documents.length; i++) {
                if ('BollyActive' == packagedata.documents[i].documentID) {
