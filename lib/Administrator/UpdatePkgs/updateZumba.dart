...
class UpdateZumba extends StatefulWidget {
    @override
    _UpdateZumbaState createState() => _UpdateZumbaState();
}

class _UpdateZumbaState extends State<UpdateZumba> {
    FirebaseUser user;
    ...
    Widget build(BuildContext context) {
        if (packagedata != null) {
            for (i = 0; i < packagedata.documents.length; i++) {
                if ('Zumba' == packagedata.documents[i].documentID) {
