...
class UpdateFunctionalTraining extends StatefulWidget {
    @override
    _UpdateFunctionalTrainingState createState() => _UpdateFunctionalTrainingState();
}

class _UpdateFunctionalTrainingState extends State<UpdateFunctionalTraining> {
    FirebaseUser user;
