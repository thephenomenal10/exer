...
class UpdatePowerYoga extends StatefulWidget {
    @override
    _UpdatePowerYogaState createState() => _UpdatePowerYogaState();
}

class _UpdatePowerYogaState extends State<UpdatePowerYoga> {
    FirebaseUser user;
