...
class UpdateStepAerobics extends StatefulWidget {
    @override
    _UpdateStepAerobicsState createState() => _UpdateStepAerobicsState();
}

class _UpdateStepAerobicsState extends State<UpdateStepAerobics> {
    FirebaseUser user;
