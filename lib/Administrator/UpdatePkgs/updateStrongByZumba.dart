...
class UpdateStrongByZumba extends StatefulWidget {
    @override
    _UpdateStrongByZumbaState createState() => _UpdateStrongByZumbaState();
}

class _UpdateStrongByZumbaState extends State<UpdateStrongByZumba> {
    FirebaseUser user;
